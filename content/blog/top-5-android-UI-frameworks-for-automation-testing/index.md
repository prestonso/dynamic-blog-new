...
<img class="main-img img-responsive" src="./top-5-android-UI-frameworks.jpg">
</div>
</center>
...
<p class="blog-content">As WebDriver was initially created for web testing, Appium extended WebDriver with extra API methods to make it more suitable for mobile automation.
...
<p class="blog-content"> Click <a href="http://appium.io/">here</a> for more information on <b>Appium</b>.</p>
<p></p>
<center>
<div style="width:88%; margin-top:20px; margin-bottom:20px;padding:20px; box-shadow:0 0 10px rgba(0,0,0,0.1)">
...
<p class="blog-content"> Click <a href="https://www.guru99.com/calabash-android-ios-testing.html">here</a> for more information on <b>Calabash</b>.</p>
<center>
<div style="width:88%; margin-top:20px; margin-bottom:20px;padding:20px; box-shadow:0 0 10px rgba(0,0,0,0.1)">
...
<p class="blog-content"> Click <a href="https://developer.android.com/training/testing/espresso">here</a> for more information on <b>Espresso</b>.</p>
<center>
<div style="width:88%; margin-top:20px; margin-bottom:20px;padding:20px; box-shadow:0 0 10px rgba(0,0,0,0.1)">
...
<p class="blog-content"> Click <a href="https://developer.android.com/training/testing/ui-automator">here</a> for more information on <b>UI Automator</b>.</p>
<center>
<div style="width:88%; margin-top:20px; margin-bottom:20px;padding:20px; box-shadow:0 0 10px rgba(0,0,0,0.1)">
...
<p></p>
<p class="blog-content"> Click <a href="https://github.com/RobotiumTech/robotium">here</a> for more information on <b>Robotium</b>. </p>
</div>
